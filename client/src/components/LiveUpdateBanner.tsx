...
export function LiveUpdateBanner() {
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-[9999] flex items-center justify-center gap-3 bg-gradient-to-r from-[#00A896] to-[#00C9B7] text-white px-4 py-2.5 text-sm font-medium shadow-lg animate-in slide-in-from-top duration-300">
